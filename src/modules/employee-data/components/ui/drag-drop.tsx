...
const DragAndDropUpload: React.FC<DragAndDropUploadProps> = ({
  ...
  return (
    <div className="col-span-full border border-dashed border-gray-300 rounded-lg p-4">
      <label className="block text-sm font-medium text-white">
        Cover photo
      </label>
      <div
        className={`mt-2 flex justify-center rounded-lg border border-dashed px-6 py-4 transition-colors ${
